...
public class MeteorBarrageLevel implements Screen, InputProcessor {
    ...
    private ray.meteorbarrage.game.BaseActor planet;
    private ray.meteorbarrage.game.BaseActor restart;
    ...
    private ArrayList<ray.meteorbarrage.game.BaseActor> projectileManager = new ArrayList<ray.meteorbarrage.game.BaseActor>();
    private ArrayList<ray.meteorbarrage.game.BaseActor> backgroundManager = new ArrayList<ray.meteorbarrage.game.BaseActor>();
...
//        music_level.play();
        ...
        for (int i = 0; i < 2; i++) {
            backgroundManager.add(new ray.meteorbarrage.game.BaseActor());
        ...
        planet = new ray.meteorbarrage.game.BaseActor();
        ...
        restart = new ray.meteorbarrage.game.BaseActor();
    ...
    private void updateMotion() {
        ...
        if (fireProjectile) {
            ray.meteorbarrage.game.BaseActor projectile = new ray.meteorbarrage.game.BaseActor();
