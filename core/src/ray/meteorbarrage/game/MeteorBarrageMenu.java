...
public class MeteorBarrageMenu implements Screen {
    ...
    private ray.meteorbarrage.game.BaseActor background;
    private ray.meteorbarrage.game.BaseActor title;
    private ray.meteorbarrage.game.BaseActor spaceship;
//    private BaseActor badlogic;
    ...
    private void create() {
        ...
        background = new ray.meteorbarrage.game.BaseActor();
...
//        uiStage.addActor(badlogic);
        ...
        spaceship = new ray.meteorbarrage.game.BaseActor();
        ...
        title = new ray.meteorbarrage.game.BaseActor();
    ...
    private void startGame() {
        dispose();
        game.setScreen(new ray.meteorbarrage.game.MeteorBarrageLevel(game));
    }
